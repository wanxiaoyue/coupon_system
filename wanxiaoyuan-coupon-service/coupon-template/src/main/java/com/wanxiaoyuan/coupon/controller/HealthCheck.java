...
public class HealthCheck {
     ...
     * 127.0.0.1:9000/wanxiaoyuan/coupon-template/health
     */
    @GetMapping("/health")
    ...
    /**
     * <h2>异常测试接口</h2>
     * 127.0.0:7001/coupon-template/exception
     */
     ...
     * 127.0.0:7001/coupon-template/info
     */
    @GetMapping("/info")
    public List<Map<String, Object>> info() {
        ...
        instances.forEach(i ->{
            ...
            info.put("service", i.getServiceId());
